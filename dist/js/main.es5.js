...
class Feet {
		...
		feetShow(name) {
				$('.rabbit').css({ 'backgroundColor': '#000', 'color': 'red', 'padding': '5px' }).text(name);
		}
}
class Hand {
		constructor(name) {
		...
		feetHidden() {
				$('.rabbit').css({ 'backgroundColor': '#666', 'color': 'green', 'padding': '5px' }).text(this.name);
		}
		feetShow(name) {
				$('.rabbit').css({ 'backgroundColor': '#666', 'color': 'green', 'padding': '5px' }).text(name);
		}
}
